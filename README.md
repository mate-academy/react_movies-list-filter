...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://anna-akhalmosulishvili.github.io/react_movies-list-filter/) and add it to the PR description.
