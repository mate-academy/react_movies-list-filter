...
- Replace `OlgaOchichenko` with your Github username in the [DEMO LINK](https://OlgaOchichenko.github.io/react_movies-list-filter/) and add it to the PR description.
