...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://defaultgituser.github.io/react_movies-list-filter-js/) and add it to the PR description.
