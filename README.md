...
> Here is [the working version](https://mate-academy.githugitb.io/react_movies-list-filter/)
...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://patryk177m.github.io/react_movies-list-filter/) and add it to the PR description.
