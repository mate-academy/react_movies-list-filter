# Movies list - SearchPanel
- Replace `<your_account>` with your Github username in the
 [DEMO LINK](https://romarios1987.github.io/react_movies-list-filter/)
...
1. SearchPanel the movies using `state.query` by searching it in the `movie.title` or `movie.description`
