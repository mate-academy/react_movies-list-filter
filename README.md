...
- Replace `Irina-Kulish` with your Github username in the [DEMO LINK](https://Irina-Kulish.github.io/react_movies-list-filter/) and add it to the PR description.
