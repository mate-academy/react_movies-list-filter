...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://allagutsul27.github.io/react_movies-list-filter-js/) and add it to the PR description.
