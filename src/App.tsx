...
const filterMovies = (movies: Movie[], searchQuery: string) => {
  return movies.filter(movie => {
    ...
    const preparedTitle = title.toLocaleLowerCase();
    const preparedDescription = description.toLocaleLowerCase();

    const titleIncludes = preparedTitle.includes(preparedQuery);
    const descriptIncludes = preparedDescription.includes(preparedQuery);
